...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { artist_id: @genre.artist_id, name: @genre.name, post_id: @genre.post_id } }, as: :json
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { artist_id: @genre.artist_id, name: @genre.name, post_id: @genre.post_id } }, as: :json
    assert_response 200
  end
